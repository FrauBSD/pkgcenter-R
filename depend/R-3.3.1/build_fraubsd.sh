...
# $FrauBSD: pkgcenter-R/depend/R-3.3.1/build_fraubsd.sh 2020-07-16 17:04:50 -0700 freebsdfrau $
#
############################################################ CONFIGURATION
...
# Patch software
#
patch -Nr- etc/Makeconf.in < files/etc_Makeconf.in.patch
patch -Nr- src/scripts/config < files/src_scripts_config.patch
