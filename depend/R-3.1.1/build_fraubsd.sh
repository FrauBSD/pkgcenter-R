...
# $FrauBSD: pkgcenter-R/depend/R-3.1.1/build_fraubsd.sh 2019-07-12 22:45:53 -0700 freebsdfrau $
#
############################################################ CONFIGURATION
...
#
# Remove a library that we want versioned by vcran
#
eval2 rm -Rf sandbox/opt/R/3.1.1/lib64/R/library/foreign
